# LottieFiles for Sketch plugin

## Installation

- [Download](../../releases/latest/download/lottiefiles.sketchplugin.zip) the latest release of the plugin
- Un-zip
- Double-click on lottiefiles.sketchplugin
